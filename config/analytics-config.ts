...
export const analyticsHelpers = {
  ...
  getConversionValue: (segment: string, action: string): number => {
    const segmentConfig =
      analyticsConfig.marketSegments[segment as keyof typeof analyticsConfig.marketSegments];
    const journeyStep =
      analyticsConfig.userJourney.steps[action as keyof typeof analyticsConfig.userJourney.steps];
