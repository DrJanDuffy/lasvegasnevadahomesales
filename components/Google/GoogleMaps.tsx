      ...
      <div className={`google-maps-placeholder ${className}`} style={{ height }}>
        <div className="flex items-center justify-center h-full bg-gray-100 rounded-lg">
          <div className="text-center p-8">
            ...
            <p className="text-gray-600 mb-4">Please provide your Google Maps API key to enable interactive mapping</p>
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <p className="text-sm text-gray-500">Key neighborhoods:</p>
              <div className="flex flex-wrap gap-2 mt-2">
                {neighborhoods.map(neighborhood => (
                  <span key={neighborhood.name} className="px-2 py-1 bg-[#3A8DDE] text-white text-xs rounded">
                    {neighborhood.name}
                  </span>
                ))}
              </div>
