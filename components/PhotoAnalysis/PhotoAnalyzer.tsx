...
export function PhotoAnalyzer({ className = '' }: PhotoAnalyzerProps) {
  ...
  return (
    <div className={`bg-white rounded-lg shadow-lg p-6 ${className}`}>
      <h2 className="text-2xl font-bold text-gray-900 mb-6">AI Photo Analysis for Real Estate</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="flex items-center gap-3 mb-3">
              <span
                className={`px-2 py-1 rounded-full text-sm font-medium ${getPriorityColor(analysis.overallRecommendation.priority)}`}
              >
                {analysis.overallRecommendation.priority.toUpperCase()} PRIORITY
              </span>
              <span
                className={`px-2 py-1 rounded-full text-sm font-medium ${analysis.overallRecommendation.useForWebsite ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
              >
            ...
            <div className="text-sm text-gray-600">
              ...
              {analysis.overallRecommendation.suggestedUse.join(', ')}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-white border rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Keywords: {analysis.seoPotential.keywords.join(', ')}
              </p>
            </div>
            ...
            <div className="bg-white border rounded-lg p-4">
              ...
              <div
                className={`text-2xl font-bold ${getScoreColor(analysis.emotionalImpact.score)}`}
              >
                {analysis.emotionalImpact.score}/10
              </div>
              <p className="text-sm text-gray-600 mt-1">
                Target: {analysis.emotionalImpact.targetAudience.join(', ')}
              </p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Real Estate Analysis</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <strong>Lifestyle Appeal:</strong>{' '}
                {analysis.realEstateSpecific.lifestyleAppeal.join(', ')}
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-50 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">SEO Suggestions</h3>
