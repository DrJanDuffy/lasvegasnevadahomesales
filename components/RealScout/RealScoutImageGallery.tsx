...
export function RealScoutImageGallery({
  ...
  if (galleryType === 'grid') {
    return (
      <div className={`real-scout-gallery ${className}`} style={{
  ...
  if (galleryType === 'masonry') {
    return (
      <div className={`real-scout-masonry ${className}`} style={{
        columns: columns,
...
export function RealScoutWidgetGallery({
  ...
  if (isLoading) {
    return (
      <div className={`real-scout-widget-loading ${className}`} style={{
        gridTemplateColumns: `repeat(${columns}, 1fr)`
      }}>
