  ...
  const summerlinProperties = [
    {
      ...
      status: "For Sale",
      description: "Stunning luxury home in the heart of Summerlin with panoramic Red Rock Canyon views. This custom-built residence features premium finishes throughout.",
      features: [
    ...
    },
    {
      ...
      propertyType: "Single Family",
      status: "For Sale",
      description: "Beautiful family home in a quiet Summerlin neighborhood. Features open concept living, updated kitchen, and private backyard oasis.",
      features: [
        "Open Concept Living",
        "Updated Kitchen",
        "Private Backyard",
