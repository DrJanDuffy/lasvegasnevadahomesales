...
export const metadata: Metadata = {
  ...
  description: "View detailed information about this Las Vegas property including photos, amenities, and contact information.",
}
...
const getPropertyData = (slug: string) => {
  const properties = {
    "1234-summerlin-pkwy": {
      ...
      status: "Active",
      daysOnMarket: 12,
      description: "Beautiful single-family home in the heart of Summerlin. This stunning property features an open floor plan, gourmet kitchen, and spacious backyard perfect for entertaining.",
      features: ["Open Floor Plan", "Gourmet Kitchen", "Master Suite", "Backyard", "2-Car Garage", "Central AC"],
      yearBuilt: 2018,
      lotSize: "0.25 acres",
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <Button href="/home-valuation" intent="secondary" className="border-blue-600 text-blue-600 hover:bg-blue-50">
                Get Home Value
              </Button>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            {property.images.map((image, index) => (
              <div key={index} className="aspect-video rounded-lg bg-gradient-to-br from-gray-300 to-gray-400">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
            ...
            <div className="space-y-8">
              ...
              <div className="rounded-lg bg-gray-50 p-6">
                ...
                <div className="space-y-3">
                  <div>
                    <label htmlFor="home-price" className="mb-1 block text-sm font-medium text-gray-700">Home Price</label>
                    <input
                      id="home-price"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="down-payment" className="mb-1 block text-sm font-medium text-gray-700">Down Payment</label>
                    <select id="down-payment" name="down-payment" className="w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900" aria-label="Select down payment percentage">
                  ...
                  <div>
                    <label htmlFor="interest-rate" className="mb-1 block text-sm font-medium text-gray-700">Interest Rate</label>
                    <input
                      id="interest-rate"
                      type="text"
                      value="4.2%"
              ...
              <div className="rounded-lg bg-gray-50 p-6">
                ...
                <Button href="/properties?neighborhood=summerlin" className="mt-4 w-full bg-gray-200 text-gray-900 hover:bg-gray-300">
