          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mb-6 text-lg text-gray-600">
                In today's dynamic Vegas market, knowing your home's true value is crucial. Our expert evaluation combines local market knowledge with advanced analytics to give you the most accurate assessment.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Understand the optimal time to sell in your neighborhood</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-6 h-6 bg-[#16B286] rounded-full flex items-center justify-center text-white text-sm font-bold">✓</div>
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Price your home to sell quickly and maximize profit</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-6 h-6 bg-[#16B286] rounded-full flex items-center justify-center text-white text-sm font-bold">✓</div>
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Expert knowledge of Vegas neighborhoods and trends</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#F7F9FC] p-6 rounded-lg border-l-4 border-[#3A8DDE]">
                ...
                <p className="text-gray-600 text-sm">
                  Homes in Summerlin, Henderson, and Green Valley are selling 15% faster than last year. 
            ...
            <div className="bg-gradient-to-br from-[#F7F9FC] to-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-[#0A2540] mb-6">Get Your Free Evaluation Today</h3>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-[#16B286] rounded-full flex items-center justify-center text-white font-bold">1</div>
                  <div>
                    <h4 className="font-semibold text-[#0A2540]">Enter Your Address</h4>
                    <p className="text-gray-600 text-sm">Start with our instant online valuation tool</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-[#3A8DDE] rounded-full flex items-center justify-center text-white font-bold">2</div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-[#FF6B35] rounded-full flex items-center justify-center text-white font-bold">3</div>
                  <div>
                    <h4 className="font-semibold text-[#0A2540]">Get Your Report</h4>
                    <p className="text-gray-600 text-sm">Receive detailed valuation and market insights</p>
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div className="bg-[#F7F9FC] p-6 rounded-lg text-center">
              <div className="w-16 h-16 bg-[#16B286] rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">💰</div>
            ...
            <div className="bg-[#F7F9FC] p-6 rounded-lg text-center">
              <div className="w-16 h-16 bg-[#3A8DDE] rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">📊</div>
            ...
            <div className="bg-[#F7F9FC] p-6 rounded-lg text-center">
              <div className="w-16 h-16 bg-[#FF6B35] rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">🎯</div>
